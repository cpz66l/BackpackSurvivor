...
- 第 16 课（7/29）单局框架与基础 HUD ◀ 当前：RunTimer / GameSession / GameState；15 分钟计时、暂停/继续边界、死亡失败入口；HUD 显示血量、时间、经验、等级、背包提示；本课目标是“一局有开始和正在进行”
- 第 17 课（7/30）经验成长与三选一：经验条、升级、暂停战斗弹出三选一；先做 4~6 个简单升级项（伤害、射速、移速、最大生命、拾取范围、投射物速度）；升级效果走统一 Modifier/Stats 入口，别散落硬改
