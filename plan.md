...
- 第 23 课（8/05）精英/宝箱/终局压力强化 ◀ 当前：精英怪有更高血量/颜色/掉落价值；宝箱节奏接入 15 分钟曲线；确认测试用高品质掉落通道不要误提交为正式经济；终局选择“高压精英潮”优先，Boss 只做可稳定跑的简化版
...
- 第22课后内容系统性价比队列：P0 已完成 = 数据源保真、掉落入口可跑、三类自动武器基础差异、FireRateBoost 芯片真实收益；P1 继续 = 精英/宝箱节奏、史诗/传说掉落展示、结算页显示背包携带价值；P2 Demo 后 = 完整物品配置 SO、Gold 商店、出售/撤离经济、全套词缀和复杂互斥规则
