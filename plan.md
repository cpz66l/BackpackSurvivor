...
- 第 16 课（7/29）单局框架与基础 HUD ✅：RunTimer / GameSession / GameState；15 分钟计时、暂停/继续边界、死亡失败入口、时间到胜利入口；HUD 显示时间、经验、等级、状态；本课目标“一局有开始和正在进行”已完成
- 第 17 课（7/30）经验成长与三选一 ◀ 当前：经验条、升级、暂停战斗弹出三选一；先做 4~6 个简单升级项（伤害、射速、移速、最大生命、拾取范围、投射物速度）；升级效果走统一 Modifier/Stats 入口，别散落硬改
- 第 18 课（7/31）波次导演与 15 分钟节奏雏形：按时间推进刷怪强度；普通怪→精英→宝箱节奏；先做高压精英潮，不急着做复杂 Boss；本课结束要能从 0 分钟跑到 15 分钟
- 第 19 课（8/01）战斗反馈快包：命中闪白/受击闪红、简单伤害数字、开火/命中/拾取/升级音效、轻量相机震动；目标是“同样的系统立刻更像游戏”，不做复杂特效管线
