...
截至 2026-08-04，项目已推进到 **第 27 个迭代节点：数值调参与首轮平衡**，核心状态如下：
...
> 说明：项目仍处于 Demo 开发中，README 中的“后续计划”不代表已经完成，实际进度以代码、提交记录和 `Docs/` 开发日志为准。`Docs/` 中“第 xx 课”的命名是个人开发节奏记录，不代表网课或教程项目。

## 开发方式说明

本项目不是网上课程项目，也不是跟做教程复刻。项目方向、玩法设计、功能取舍、实现决策和代码落地均由本人独立完成。

AI 主要作为开发辅助工具使用，具体用于：

- 梳理项目阶段目标、拆分任务和复盘文档结构。
- 对代码进行 review，指出潜在 bug、职责边界和可维护性问题。
- 在调试时帮助快速定位异常链路，例如 Unity 序列化引用丢失、对象池状态未重置、UI 射线遮挡、伤害显示与真实规则不一致等问题。
- 辅助整理面试表达和技术复盘，但项目代码均由本人理解后手动实现与验证。
...
- [迭代 20：胜负结算与重开闭环](./Docs/第20课-胜负结算与重开闭环.md)
- [迭代 21：构筑最小兑现](./Docs/第21课-构筑最小兑现.md)
- [迭代 22：内容面铺开](./Docs/第22课-内容面铺开.md)
- [迭代 23：精英宝箱与终局压力强化](./Docs/第23课-精英宝箱与终局压力强化.md)
- [迭代 24：金币掉落与局内经济 HUD](./Docs/第24课-金币掉落与局内经济HUD.md)
- [迭代 25：背包价值与物品价值显示](./Docs/第25课-背包价值与物品价值显示.md)
- [迭代 26：合并升级收益兑现](./Docs/第26课-合并升级收益兑现.md)
- [迭代 27：数值调参台与首轮平衡](./Docs/第27课-数值调参台与首轮平衡.md)
