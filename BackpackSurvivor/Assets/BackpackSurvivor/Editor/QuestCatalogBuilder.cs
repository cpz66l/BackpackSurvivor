...
namespace BackpackSurvivor.EditorTools
{
    public static class QuestCatalogBuilder
    {
        ...
        public static QuestDatabase Build()
        {
            ...
            var sets = new[] {
                new[] { new ObjectiveClause { type=ObjectiveType.CarryTag, tag=ItemTag.Medical, count=2 } },
                new[] { new ObjectiveClause { type=ObjectiveType.KillTotal, count=900 }, new ObjectiveClause {type=ObjectiveType.KillElite,count=30} },
                new[] { new ObjectiveClause { type=ObjectiveType.ReachLevel, count=30 } },
                new[] { new ObjectiveClause { type=ObjectiveType.CarryTagSet, tags=weaponTags, count=2 }, Value(28000) },
                new[] { new ObjectiveClause { type=ObjectiveType.CarryRarity, rarity=Rarity.Rare, count=2 }, Value(25000) },
                new[] { new ObjectiveClause { type=ObjectiveType.OpenChestAtLeast, minChestQuality=ChestQuality.Uncommon, count=2 }, new ObjectiveClause {type=ObjectiveType.KillElite,count=80} },
                ...
                new[] { new ObjectiveClause { type=ObjectiveType.CarryRarity, rarity=Rarity.Epic }, Value(50000) },
                new[] { new ObjectiveClause { type=ObjectiveType.CarryAnyItemAtLevel,itemLevel=2,count=2 },new ObjectiveClause {type=ObjectiveType.KillElite,count=140} },
                new[] { new ObjectiveClause { type=ObjectiveType.CarryAnyItemAtLevel,itemLevel=3 },new ObjectiveClause {type=ObjectiveType.KillElite,count=220} },
                new[] { new ObjectiveClause {type=ObjectiveType.CarryTagSet,tags=weaponTags,count=3},new ObjectiveClause {type=ObjectiveType.KillElite,count=220} },
                new[] { new ObjectiveClause {type=ObjectiveType.OpenChestAtLeast,minChestQuality=ChestQuality.Epic,count=2},Value(75000) },
                new[] { FinalItem(database), Value(100000), new ObjectiveClause {type=ObjectiveType.KillElite,count=300} },
                new[] { FinalItem(database), Value(100000), new ObjectiveClause {type=ObjectiveType.KillElite,count=220}, new ObjectiveClause {type=ObjectiveType.OpenChestAtLeast,minChestQuality=ChestQuality.Epic,count=4} },
                new[] { FinalItem(database), Value(110000),new ObjectiveClause {type=ObjectiveType.KillElite,count=180}, new ObjectiveClause {type=ObjectiveType.CarryAnyItemAtLevel,itemLevel=3} }
            };
            ...
            for (int i = 0; i < sets.Length; i++)
            {
                ...
                definition.definitionVersion = "balance-2";
